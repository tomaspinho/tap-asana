...
class Tasks(Stream):
  ...
  def get_objects(self):
    ...
    for i, project in enumerate(projects):
      ...
      LOGGER.info("Syncing stream tasks: getting %d tasks for project %s, %d/%d", num_tasks, project_gid, i+1, projects_len)
